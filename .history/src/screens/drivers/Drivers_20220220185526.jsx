        ...
        <div className="card-container">
          ...
          <div className="card-wrapper2">
            ...
            <div className="card-listing">
              ...
              <p>This vehicle is listed by Roadlers, accompanied by highly trained chauffeurs and dedicated customer care agents to meet your expectations. GSO Drive </p>
            </div>
          </div>
        </div>
      </div>
