        ...
        <div className="card-booking">
          <div className="card-wrapper">
            ...
            <div className="card-text">
              ...
              <p>This is a trained professional individuals, supported by dedicated customer care agents to meet your needs. He would work with you 10 hours daily from morning till evening 6 days a week. Some of the benefits include:s</p>
