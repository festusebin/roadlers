        ...
        <div className="card-booking">
          <div className="card-wrapper">
            ...
            <div className="card-text">
              ...
              <p>A personal driver boooking link will be sent to the receiver via email and SMS to use the services any day they need it. We would also let the receiver know that the gift is from you!.At Roadlers all our executive drivers are highly trained professional individuals, supported by dedicated customer care agents to meet your needs.</p>
