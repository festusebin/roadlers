...
import DayGift from '../../assets/images/gift-request.png';
        ...
        <div className="card-booking">
          <div className="card-wrapper">
            <div className="card-section">
              <img className='driver' src={DayGift} alt="day-gifts" />
              <img className='like' src={LikeIcon} alt="like" />
            </div>
            <div className="card-text">
              <h2>Daily Drivers Gift Card</h2>
              <div className="card-text-line"></div>
              <div className="card-location">
                <img src={MarkerDark} alt="marker" />
                <span>Lagos</span>
              </div>
              <p>A personal driver boooking link will be sent to the receiver via email and SMS to use the services any day they need it. We would also let the receiver know that the gift is from you!.</p>
              
              <p>At Roadlers all our executive drivers are highly trained professional individuals, supported by dedicated customer care agents to meet your needs.</p>
